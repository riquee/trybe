...
const checkRand = (number) => number == rand() ? "Parabéns você ganhou" : "Tente novamente";
...
const repeat = (array1, array2, fn) => {
  ...
  for (let index = 0; index < array1.length; index += 1) {
    count += fn(array1[index], array2[index]);
  }
  return `TOTAL DE PONTOS: ${count}`;
};

const test = repeat(rightAnswers, studentAnswers, (elem1, elem2) => {
